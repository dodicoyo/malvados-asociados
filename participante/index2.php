...
<body data-spy="scroll" data-target=".fixed-top">
    ...
    <nav class="navbar navbar-expand-md navbar-dark navbar-custom fixed-top">
        ...
        <picture class="logo" >
                ...
                <img  loading="lazy"  style="width:50px;" src="build/img/control/logo.avif" alt="alternative">
        </picture>
        ...
        <div class="collapse navbar-collapse" id="navbarsExampleDefault">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link page-scroll" href="#services">Eventos</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link page-scroll" href="#contact">Contactos</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link page-scroll" href="#projects">Preguntas Frecuentes</a>
                </li>
                <li class="nav-item">
                    ...
                    <?php 
                        ...
                        ?>
                            ...
                            <div class="card">
                                ...
                                <?php echo"<a class='btn-solid-reg page-scroll'  href='#details?id_evento=".$row[0]."'>Conoce mas...".$row[0]."</a>";?>
